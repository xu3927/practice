    ...
    return {
        ...
        visitor: {
            ReferencedIdentifier: function ReferencedIdentifier(path, state) {
                ...
                path.replaceWith(state.addImport(moduleName + "/core-js/" + definitions.builtins[node.name], "default", node.name));
            },
            ...
            MemberExpression: {
                ...
                exit: function exit(path, state) {
                    ...
                    var moduleName = getRuntimeModuleName(state.opts);
                    path.replaceWith(t.memberExpression(state.addImport(moduleName + "/core-js/" + definitions.builtins[obj.name], "default", obj.name), node.property, node.computed));
                }
            }
        }
    };
